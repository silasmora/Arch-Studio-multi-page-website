...
const Header = () => {
  ...
  return (
    ...
    md:before:content-[""] md:before:absolute md:before:border md:before:border-lightGrey md:before:h-[104px] md:before:top-0 md:before:-left-8 lg:before:left-0 md:before:ml-[86px]'>
      ...
      <svg className='md:hidden' xmlns="http://www.w3.org/2000/svg" width="24" height="17"><g fill="#1B1D23" fill-rule="evenodd"><path d="M0 0h24v3H0zM0 7h24v3H0zM0 14h24v3H0z"/></g></svg>
    </div>
  )
}
